...
app = Dash(server=Flask(__name__), 
    ...
    return dbc.Container([
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        ...
                        dbc.Row([
                                dbc.Col(fig_with_wells, md=6, className="graph-border"),
                                dbc.Col(fig_plus, md=6, className="graph-border"),
                            ]),
                            dbc.Row([
...
# from devgraph import test_me
from xlsx_parser import fig_with_wells, fig_plus
